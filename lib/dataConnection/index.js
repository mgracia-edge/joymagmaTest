...
const dbClusterEdgeTest = 'mongodb+srv://nx_studio:U6UBfekBsGUeBW5b@edgetest.pm6cd.mongodb.net/joy-comm-dev'
const dbClusterMongoAtlasTest = 'mongodb+srv://nx_studio:U6UBfekBsGUeBW5b@nxservices-pm6cd.gcp.mongodb.net/joy-comm-dev'

const mongoose = require('mongoose');
const schema = require('./schema');

const URL = typeof process.env.DB_URL !== 'undefined' ? process.env.DB_URL : dbClusterEdgeTest;
