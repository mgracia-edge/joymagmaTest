...
exports.bind = function () {
    ...
    let StatsPlayingResume = new Schema({
        ...
        channels: [Schema.Types.ObjectId],
        channelsDistribution: [Number], // Applies Only for Daily
        operators: [String],
        operatorsDistribution: [Number], // Applies Only for Daily
        date: {type: Date, index: true},
        avgPerSub: {
            playingTime: Number,
            channels: Number,
    ...
    db.Stats5mPlayingResume = mongoose.model('stats5mPlayingResumes', StatsPlayingResume);
