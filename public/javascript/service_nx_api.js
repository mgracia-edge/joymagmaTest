...
(function () {
    ...
    angular.module('NxStudio')
        .factory('$NxApi', ['$http', '$q', '$NxNav', function ($http, $q, $NxNav) {
            ...
            function vodPostersDelegation($http, $q) {

                function create(params) {
                    return $q((resolve, reject) => {
                        $http.post("/api/1.0/vodPoster/create", params, {
                            headers: {
                                "Authorization": "Bearer " + session.token
                            }
                        })
                ...
                function read(params) {
                    ...
                    return $q((resolve, reject) => {
                        $http.post("/api/1.0/vodPoster/read", {
                            id: params._id,
                            data: params
                        }, {
                            headers: {
            ...
            function RadiosDelegation($http,$q){
                ...
                function update(params) {
                    ...
                    return $q((resolve, reject) => {
                        $http.post("/api/1.0/radio/update", {
                            id: params._id,
                            data: params
                        }, {
                            headers: {
                ...
                function remove(params) {
                    return $q((resolve, reject) => {
                        $http.post("/api/1.0/radio/delete", {
                            id: params._id
                        }, {
                            headers: {
                                "Authorization": "Bearer " + session.token
